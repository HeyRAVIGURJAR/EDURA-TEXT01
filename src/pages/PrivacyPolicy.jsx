        ...
        >
          ...
          <section className="mb-10 relative z-10">
            <h2 className="text-2xl font-semibold mb-4 text-white flex items-center gap-2">
              <span className="text-[#8b5cf6]">01.</span> Data Protection Commitment
            </h2>
          ...
          <section className="mb-10 relative z-10">
            <h2 className="text-2xl font-semibold mb-4 text-white flex items-center gap-2">
              <span className="text-[#8b5cf6]">02.</span> No-Data-Monetization Policy
            </h2>
          ...
          <section className="mb-10 relative z-10">
            <h2 className="text-2xl font-semibold mb-4 text-white flex items-center gap-2">
              <span className="text-[#8b5cf6]">03.</span> Saarthi AI & Integrations
            </h2>
            <p className="text-gray-400 leading-relaxed mb-4">
          ...
          <section className="mb-10 relative z-10">
            <h2 className="text-2xl font-semibold mb-4 text-white flex items-center gap-2">
              <span className="text-[#8b5cf6]">04.</span> Local Security & Storage
            </h2>
